...
func (ContributorParameterSource) Descriptor() protoreflect.EnumDescriptor {
	return file_WebAPI_metadata_admin_2_proto_enumTypes[0].Descriptor()
}

func (ContributorParameterSource) Type() protoreflect.EnumType {
	return &file_WebAPI_metadata_admin_2_proto_enumTypes[0]
}
...
func (ContributorParameterSource) EnumDescriptor() ([]byte, []int) {
	return file_WebAPI_metadata_admin_2_proto_rawDescGZIP(), []int{0}
}
...
func (MetadataAdminResult_ResultCode) Descriptor() protoreflect.EnumDescriptor {
	return file_WebAPI_metadata_admin_2_proto_enumTypes[1].Descriptor()
}

func (MetadataAdminResult_ResultCode) Type() protoreflect.EnumType {
	return &file_WebAPI_metadata_admin_2_proto_enumTypes[1]
}
...
func (MetadataAdminResult_ResultCode) EnumDescriptor() ([]byte, []int) {
	return file_WebAPI_metadata_admin_2_proto_rawDescGZIP(), []int{1, 0}
}
...
func (x *MetadataAdminRequest) Reset() {
	*x = MetadataAdminRequest{}
	mi := &file_WebAPI_metadata_admin_2_proto_msgTypes[0]
...
func (x *MetadataAdminResult) Reset() {
	*x = MetadataAdminResult{}
	mi := &file_WebAPI_metadata_admin_2_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MetadataAdminResult) Descriptor() ([]byte, []int) {
	return file_WebAPI_metadata_admin_2_proto_rawDescGZIP(), []int{1}
}
...
func (x *MetadataAdminResult) GetDetails() *shared_1.Text {
	if x != nil {
		return x.Details
	}
	return nil
...
func (x *ContributorParameters) Reset() {
	*x = ContributorParameters{}
	mi := &file_WebAPI_metadata_admin_2_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ContributorParameters) Descriptor() ([]byte, []int) {
	return file_WebAPI_metadata_admin_2_proto_rawDescGZIP(), []int{2}
}
...
func (x *ContributorParameter) Reset() {
	*x = ContributorParameter{}
	mi := &file_WebAPI_metadata_admin_2_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ContributorParameter) Descriptor() ([]byte, []int) {
	return file_WebAPI_metadata_admin_2_proto_rawDescGZIP(), []int{3}
}
...
func (x *GetSecurityParameters) Reset() {
	*x = GetSecurityParameters{}
	mi := &file_WebAPI_metadata_admin_2_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetSecurityParameters) Descriptor() ([]byte, []int) {
	return file_WebAPI_metadata_admin_2_proto_rawDescGZIP(), []int{4}
}
...
func (x *GetSecurityParametersResult) Reset() {
	*x = GetSecurityParametersResult{}
	mi := &file_WebAPI_metadata_admin_2_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetSecurityParametersResult) Descriptor() ([]byte, []int) {
	return file_WebAPI_metadata_admin_2_proto_rawDescGZIP(), []int{5}
}
...
func (x *SetSecurityParameters) Reset() {
	*x = SetSecurityParameters{}
	mi := &file_WebAPI_metadata_admin_2_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SetSecurityParameters) Descriptor() ([]byte, []int) {
	return file_WebAPI_metadata_admin_2_proto_rawDescGZIP(), []int{6}
}
...
func (x *SetSecurityParametersResult) Reset() {
	*x = SetSecurityParametersResult{}
	mi := &file_WebAPI_metadata_admin_2_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SetSecurityParametersResult) Descriptor() ([]byte, []int) {
	return file_WebAPI_metadata_admin_2_proto_rawDescGZIP(), []int{7}
}
...
func (x *PublishContract) Reset() {
	*x = PublishContract{}
	mi := &file_WebAPI_metadata_admin_2_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PublishContract) Descriptor() ([]byte, []int) {
	return file_WebAPI_metadata_admin_2_proto_rawDescGZIP(), []int{8}
}
...
func (x *PublishContractResult) Reset() {
	*x = PublishContractResult{}
	mi := &file_WebAPI_metadata_admin_2_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PublishContractResult) Descriptor() ([]byte, []int) {
	return file_WebAPI_metadata_admin_2_proto_rawDescGZIP(), []int{9}
}
...
func (x *UnpublishContract) Reset() {
	*x = UnpublishContract{}
	mi := &file_WebAPI_metadata_admin_2_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UnpublishContract) Descriptor() ([]byte, []int) {
	return file_WebAPI_metadata_admin_2_proto_rawDescGZIP(), []int{10}
}
...
func (x *UnpublishContractResult) Reset() {
	*x = UnpublishContractResult{}
	mi := &file_WebAPI_metadata_admin_2_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UnpublishContractResult) Descriptor() ([]byte, []int) {
	return file_WebAPI_metadata_admin_2_proto_rawDescGZIP(), []int{11}
}
...
func (x *GetContractParameters) Reset() {
	*x = GetContractParameters{}
	mi := &file_WebAPI_metadata_admin_2_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetContractParameters) Descriptor() ([]byte, []int) {
	return file_WebAPI_metadata_admin_2_proto_rawDescGZIP(), []int{12}
}
...
func (x *GetContractParametersResult) Reset() {
	*x = GetContractParametersResult{}
	mi := &file_WebAPI_metadata_admin_2_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetContractParametersResult) Descriptor() ([]byte, []int) {
	return file_WebAPI_metadata_admin_2_proto_rawDescGZIP(), []int{13}
}
...
var File_WebAPI_metadata_admin_2_proto protoreflect.FileDescriptor

var file_WebAPI_metadata_admin_2_proto_rawDesc = string([]byte{
	0x0a, 0x1d, 0x57, 0x65, 0x62, 0x41, 0x50, 0x49, 0x2f, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74,
	0x61, 0x5f, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x5f, 0x32, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12,
	0x10, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x5f, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x5f,
	0x32, 0x1a, 0x15, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2f, 0x73, 0x68, 0x61, 0x72, 0x65, 0x64,
	0x5f, 0x31, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xfa, 0x03, 0x0a, 0x14, 0x4d, 0x65, 0x74,
	...
	,
	...
	,
	...
	,
	...
	0x52, 0x0a, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x22, 0x72, 0x0a, 0x14,
	...
	,
	...
	0x74, 0x65, 0x72, 0x73, 0x22, 0x98, 0x01, 0x0a, 0x15, 0x53, 0x65, 0x74, 0x53, 0x65, 0x63, 0x75,
	...
	,
	...
	0x65, 0x72, 0x73, 0x18, 0x07, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x27, 0x2e, 0x6d, 0x65, 0x74, 0x61,
	...
	0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x12, 0x20, 0x0a, 0x0b, 0x64, 0x65, 0x73,
	...
	,
	...
	,
})

var (
	file_WebAPI_metadata_admin_2_proto_rawDescOnce sync.Once
	file_WebAPI_metadata_admin_2_proto_rawDescData []byte
)

func file_WebAPI_metadata_admin_2_proto_rawDescGZIP() []byte {
	file_WebAPI_metadata_admin_2_proto_rawDescOnce.Do(func() {
		file_WebAPI_metadata_admin_2_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_WebAPI_metadata_admin_2_proto_rawDesc), len(file_WebAPI_metadata_admin_2_proto_rawDesc)))
	})
	return file_WebAPI_metadata_admin_2_proto_rawDescData
}

var file_WebAPI_metadata_admin_2_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_WebAPI_metadata_admin_2_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_WebAPI_metadata_admin_2_proto_goTypes = []any{
	...
	(*shared_1.Text)(nil),                        // 16: shared_1.Text
}
var file_WebAPI_metadata_admin_2_proto_depIdxs = []int32{
...
func init() { file_WebAPI_metadata_admin_2_proto_init() }
func file_WebAPI_metadata_admin_2_proto_init() {
	if File_WebAPI_metadata_admin_2_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_WebAPI_metadata_admin_2_proto_rawDesc), len(file_WebAPI_metadata_admin_2_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   14,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_WebAPI_metadata_admin_2_proto_goTypes,
		DependencyIndexes: file_WebAPI_metadata_admin_2_proto_depIdxs,
		EnumInfos:         file_WebAPI_metadata_admin_2_proto_enumTypes,
		MessageInfos:      file_WebAPI_metadata_admin_2_proto_msgTypes,
	}.Build()
	File_WebAPI_metadata_admin_2_proto = out.File
	file_WebAPI_metadata_admin_2_proto_goTypes = nil
	file_WebAPI_metadata_admin_2_proto_depIdxs = nil
}
