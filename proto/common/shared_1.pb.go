...
func (OrderStatus_Status) Descriptor() protoreflect.EnumDescriptor {
	return file_common_shared_1_proto_enumTypes[0].Descriptor()
}

func (OrderStatus_Status) Type() protoreflect.EnumType {
	return &file_common_shared_1_proto_enumTypes[0]
}
...
func (OrderStatus_Status) EnumDescriptor() ([]byte, []int) {
	return file_common_shared_1_proto_rawDescGZIP(), []int{1, 0}
}
...
func (TransactionStatus_Status) Descriptor() protoreflect.EnumDescriptor {
	return file_common_shared_1_proto_enumTypes[1].Descriptor()
}

func (TransactionStatus_Status) Type() protoreflect.EnumType {
	return &file_common_shared_1_proto_enumTypes[1]
}
...
func (TransactionStatus_Status) EnumDescriptor() ([]byte, []int) {
	return file_common_shared_1_proto_rawDescGZIP(), []int{2, 0}
}
...
func (SignOnResult_ResultCode) Descriptor() protoreflect.EnumDescriptor {
	return file_common_shared_1_proto_enumTypes[2].Descriptor()
}

func (SignOnResult_ResultCode) Type() protoreflect.EnumType {
	return &file_common_shared_1_proto_enumTypes[2]
}
...
func (SignOnResult_ResultCode) EnumDescriptor() ([]byte, []int) {
	return file_common_shared_1_proto_rawDescGZIP(), []int{4, 0}
}
...
func (Entitlement_EntitlementType) Descriptor() protoreflect.EnumDescriptor {
	return file_common_shared_1_proto_enumTypes[3].Descriptor()
}

func (Entitlement_EntitlementType) Type() protoreflect.EnumType {
	return &file_common_shared_1_proto_enumTypes[3]
}
...
func (Entitlement_EntitlementType) EnumDescriptor() ([]byte, []int) {
	return file_common_shared_1_proto_rawDescGZIP(), []int{7, 0}
}
...
func (x *Text) Reset() {
	*x = Text{}
	mi := &file_common_shared_1_proto_msgTypes[0]
...
func (*Text) Descriptor() ([]byte, []int) {
	return file_common_shared_1_proto_rawDescGZIP(), []int{0}
}
...
func (x *OrderStatus) Reset() {
	*x = OrderStatus{}
	mi := &file_common_shared_1_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OrderStatus) Descriptor() ([]byte, []int) {
	return file_common_shared_1_proto_rawDescGZIP(), []int{1}
}
...
func (x *TransactionStatus) Reset() {
	*x = TransactionStatus{}
	mi := &file_common_shared_1_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TransactionStatus) Descriptor() ([]byte, []int) {
	return file_common_shared_1_proto_rawDescGZIP(), []int{2}
}
...
func (x *SignOnRequest) Reset() {
	*x = SignOnRequest{}
	mi := &file_common_shared_1_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SignOnRequest) Descriptor() ([]byte, []int) {
	return file_common_shared_1_proto_rawDescGZIP(), []int{3}
}
...
func (x *SignOnResult) Reset() {
	*x = SignOnResult{}
	mi := &file_common_shared_1_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SignOnResult) Descriptor() ([]byte, []int) {
	return file_common_shared_1_proto_rawDescGZIP(), []int{4}
}
...
func (x *EntitlementRequest) Reset() {
	*x = EntitlementRequest{}
	mi := &file_common_shared_1_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*EntitlementRequest) Descriptor() ([]byte, []int) {
	return file_common_shared_1_proto_rawDescGZIP(), []int{5}
}
...
func (x *EntitlementReport) Reset() {
	*x = EntitlementReport{}
	mi := &file_common_shared_1_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*EntitlementReport) Descriptor() ([]byte, []int) {
	return file_common_shared_1_proto_rawDescGZIP(), []int{6}
}
...
func (x *Entitlement) Reset() {
	*x = Entitlement{}
	mi := &file_common_shared_1_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Entitlement) Descriptor() ([]byte, []int) {
	return file_common_shared_1_proto_rawDescGZIP(), []int{7}
}
...
func (x *Destination) Reset() {
	*x = Destination{}
	mi := &file_common_shared_1_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Destination) Descriptor() ([]byte, []int) {
	return file_common_shared_1_proto_rawDescGZIP(), []int{8}
}
...
func (x *ApplePushNotif) Reset() {
	*x = ApplePushNotif{}
	mi := &file_common_shared_1_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ApplePushNotif) Descriptor() ([]byte, []int) {
	return file_common_shared_1_proto_rawDescGZIP(), []int{9}
}
...
func (x *GooglePushNotif) Reset() {
	*x = GooglePushNotif{}
	mi := &file_common_shared_1_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GooglePushNotif) Descriptor() ([]byte, []int) {
	return file_common_shared_1_proto_rawDescGZIP(), []int{10}
}
...
func (x *NotificationProperty) Reset() {
	*x = NotificationProperty{}
	mi := &file_common_shared_1_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NotificationProperty) Descriptor() ([]byte, []int) {
	return file_common_shared_1_proto_rawDescGZIP(), []int{11}
}
...
func (x *EmailNotif) Reset() {
	*x = EmailNotif{}
	mi := &file_common_shared_1_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*EmailNotif) Descriptor() ([]byte, []int) {
	return file_common_shared_1_proto_rawDescGZIP(), []int{12}
}
...
func (x *EmailFromProfileNotif) Reset() {
	*x = EmailFromProfileNotif{}
	mi := &file_common_shared_1_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*EmailFromProfileNotif) Descriptor() ([]byte, []int) {
	return file_common_shared_1_proto_rawDescGZIP(), []int{13}
}
...
func (x *SmsNotif) Reset() {
	*x = SmsNotif{}
	mi := &file_common_shared_1_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SmsNotif) Descriptor() ([]byte, []int) {
	return file_common_shared_1_proto_rawDescGZIP(), []int{14}
}
...
func (x *SmsToPhoneFromProfileNotif) Reset() {
	*x = SmsToPhoneFromProfileNotif{}
	mi := &file_common_shared_1_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SmsToPhoneFromProfileNotif) Descriptor() ([]byte, []int) {
	return file_common_shared_1_proto_rawDescGZIP(), []int{15}
}
...
func (x *NamedValue) Reset() {
	*x = NamedValue{}
	mi := &file_common_shared_1_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NamedValue) Descriptor() ([]byte, []int) {
	return file_common_shared_1_proto_rawDescGZIP(), []int{16}
}
...
var File_common_shared_1_proto protoreflect.FileDescriptor

var file_common_shared_1_proto_rawDesc = string([]byte{
	0x0a, 0x15, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2f, 0x73, 0x68, 0x61, 0x72, 0x65, 0x64, 0x5f,
	0x31, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x08, 0x73, 0x68, 0x61, 0x72, 0x65, 0x64, 0x5f,
	0x31, 0x22, 0x5a, 0x0a, 0x04, 0x54, 0x65, 0x78, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79,
	...
	,
	...
	0x1f, 0x0a, 0x07, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x08,
	0x3a, 0x05, 0x66, 0x61, 0x6c, 0x73, 0x65, 0x52, 0x07, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x64,
	0x42, 0x1b, 0x5a, 0x19, 0x67, 0x6f, 0x2d, 0x77, 0x65, 0x62, 0x73, 0x6f, 0x63, 0x6b, 0x65, 0x74,
	0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x57, 0x65, 0x62, 0x41, 0x50, 0x49,
})

var (
	file_common_shared_1_proto_rawDescOnce sync.Once
	file_common_shared_1_proto_rawDescData []byte
)

func file_common_shared_1_proto_rawDescGZIP() []byte {
	file_common_shared_1_proto_rawDescOnce.Do(func() {
		file_common_shared_1_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_common_shared_1_proto_rawDesc), len(file_common_shared_1_proto_rawDesc)))
	})
	return file_common_shared_1_proto_rawDescData
}

var file_common_shared_1_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_common_shared_1_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_common_shared_1_proto_goTypes = []any{
...
var file_common_shared_1_proto_depIdxs = []int32{
...
func init() { file_common_shared_1_proto_init() }
func file_common_shared_1_proto_init() {
	if File_common_shared_1_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_shared_1_proto_rawDesc), len(file_common_shared_1_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   17,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_shared_1_proto_goTypes,
		DependencyIndexes: file_common_shared_1_proto_depIdxs,
		EnumInfos:         file_common_shared_1_proto_enumTypes,
		MessageInfos:      file_common_shared_1_proto_msgTypes,
	}.Build()
	File_common_shared_1_proto = out.File
	file_common_shared_1_proto_goTypes = nil
	file_common_shared_1_proto_depIdxs = nil
}
